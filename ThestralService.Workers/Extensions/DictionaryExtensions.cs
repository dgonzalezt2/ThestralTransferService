...
public static class DictionaryExtensions
{
    ...
    public static TransferOperations GetUserEventType(this IDictionary<string, object> headers)
    {
        ...
        if (headers != null && headers.TryGetValue(key, out object eventTypeHeader))
        {
            ...
            if (!Enum.TryParse(eventType, true, out TransferOperations operation))
            {
